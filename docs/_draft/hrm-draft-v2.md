...
| **Locale-first routing** ([`.cursor/rules/i18n-directory.mdc`](.cursor/rules/i18n-directory.mdc)) | All UI under `/[locale]/o/[orgSlug]/apps/hrm/{capability}`; revalidate via `toLocaleOrgAppsRevalidatePattern("/hrm")` |
