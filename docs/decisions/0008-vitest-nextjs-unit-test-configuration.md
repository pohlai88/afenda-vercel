...
| 2026-05-14 | Conditional workers: without **`--coverage`**, **`forks`** + default **`maxWorkers`** / **`fileParallelism`** for faster local runs; **`--coverage`** keeps **`maxWorkers: 1`** + **`fileParallelism: false`**. |
