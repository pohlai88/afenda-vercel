# ADR-0002 — iThink: OneThing rebuilt on Planify backbone

| Field          | Value |
| -------------- | ----- |
| **Status**     | Accepted |
| **Date**       | 2026-05-10 |
| **Amended**    | 2026-05-10 — **Renumbered ADR-0004 → ADR-0002** (decisions ledger cleanup); companion / phase ADRs retired — phasing **closed** same date |
| **Supersedes** | OneThing UI surface only (not OneThing domain model or operational schema) |
| **Companion**  | *(retired ledger)* OneThing dashboard surface superseded by iThink; historical deprecation ADRs removed from `docs/decisions/`. |
| **Phasing**    | **Closed** 2026-05-10 — v1 implementation + recorded deviations (standalone phase doc retired with ledger cleanup). |
