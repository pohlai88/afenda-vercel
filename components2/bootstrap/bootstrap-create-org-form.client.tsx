...
export function BootstrapCreateOrgForm({
  prepareSlugAction,
}: {
  prepareSlugAction: PrepareSlugAction
}) {
  const router = useRouter()
  const t = useTranslations("Bootstrap.bootstrap.form")
      ...
      <CardContent>
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="bootstrap-org-name">{t("orgNameLabel")}</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="bootstrap-org-slug">{t("slugLabel")}</Label>
            <Input
