...
import { APP_SHELL_UTILITY_DISC_CLASS } from "./utility-bar.client"
import { AppShellUtilityBarIconDropdown } from "./utility-bar-icon-dropdown.client"
import { buildAppShellAccountDropdownGroups } from "./utility-bar-account-dropdown.groups"
import type { AppShellAccountDropdownHrefs } from "./utility-bar-account-dropdown.groups"
...
export type AppShellAccountDropdownProps = {
   ...
   * `authClient.signOut` + locale home refresh, matching workbench control menu.
   */
  onSignOut?: () => void
}
