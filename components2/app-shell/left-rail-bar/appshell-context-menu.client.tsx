      ...
      <DialogContent className="sm:max-w-xs">
        ...
        <DialogFooter className="gap-2">
          ...
          <Button size="sm" disabled={!label.trim()} onClick={onAdd}>
            Add to {LANE_MEMORY_LABELS[lane]}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
...
// ---------------------------------------------------------------------------
// AppShellContextMenu — wraps any content area with a right-click "Add to memory"
// ---------------------------------------------------------------------------
 ...
 */
export function AppShellContextMenu({ children }: { children: ReactNode }) {
