...
export type AppShellPrimaryLeftRailFooterProps = {
...
// ---------------------------------------------------------------------------
// AppShellPrimaryLeftRailFooter — sidebar mode control only (expanded / hover / collapsed)
// ---------------------------------------------------------------------------

export function AppShellPrimaryLeftRailFooter({
  labels = {},
}: AppShellPrimaryLeftRailFooterProps) {
  ...
  const modes = useMemo(
    (): { mode: RailMode; label: string; description: string }[] => [
