...
import {
  APP_SHELL_UTILITY_DROPDOWN_CONTENT_NARROW_CLASS,
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="start"
        sideOffset={8}
        className={APP_SHELL_UTILITY_DROPDOWN_CONTENT_NARROW_CLASS}
      >
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="start"
        sideOffset={8}
        className={APP_SHELL_UTILITY_DROPDOWN_CONTENT_WIDE_CLASS}
      >
        {dropdownContent}
      </DropdownMenuContent>
    </DropdownMenu>
