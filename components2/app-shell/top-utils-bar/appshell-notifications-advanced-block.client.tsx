...
import { Tabs, TabsList, TabsTrigger } from "#components2/ui/tabs"
...
export type AppShellNotificationsAdvancedBlockProps = {
  canManage: boolean
  open: boolean
...
export function AppShellNotificationsAdvancedBlock({
  ...
  onClose,
  onCreateNotice,
}: AppShellNotificationsAdvancedBlockProps) {
        ...
        <AppShellUtilityTriggerTooltip tooltip={t("tooltip")} align="end">
          <SheetTrigger asChild>
            <button
              ...
              className={cn(APP_SHELL_UTILITY_L2_ICON_CLASS, "relative")}
            >
              <Bell
