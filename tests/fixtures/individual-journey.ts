/**
 * Copy and env contract for individual sign-up → personal todos journeys (Playwright + docs).
...
/** Keys under `Dashboard.Todos` in `messages/en.json` — keep aligned for assertions. */
export const PERSONAL_TODOS_COPY = {
