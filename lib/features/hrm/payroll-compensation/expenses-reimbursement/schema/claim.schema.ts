...
export const claimDuplicateOverrideSchema = z.object({
  claimId: z.string().uuid("Claim ID must be a valid UUID"),
  overrideReason: z
    .string()
...
export type ClaimDuplicateOverrideValues = z.infer<
  typeof claimDuplicateOverrideSchema
>

export const claimReturnDecisionSchema = z.object({
  claimId: z.string().uuid("Claim ID must be a valid UUID"),
  returnedReason: z
    .string()
...
export type ClaimReturnDecisionValues = z.infer<typeof claimReturnDecisionSchema>
