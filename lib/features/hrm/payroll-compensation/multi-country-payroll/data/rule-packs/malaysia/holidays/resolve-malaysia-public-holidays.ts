...
export function resolveMalaysiaPublicHolidayDates(
  ...
  throw new Error(
    `Malaysia public holidays: no versioned table for calendar year ${year} (supported: 2026–2027). Add lib/features/hrm/payroll-compensation/multi-country-payroll/data/rule-packs/malaysia/holidays/v${year}.holidays.ts and register it in resolve-malaysia-public-holidays.ts; see docs/_draft/malaysia-statutory-calendar-ops.md.`
  )
}
