/**
 * Stable area keys for HRM-GEO-001 … HRM-GEO-032 (see ARCHITECTURE.md).
 * Area slugs are implementation tags — not acceptance-criteria status.
 */
export const HRM_GEOLOCATION_SPEC_MAP = {
...
export type HrmGeolocationSpecCode = keyof typeof HRM_GEOLOCATION_SPEC_MAP

export type HrmGeolocationSpecArea =
  (typeof HRM_GEOLOCATION_SPEC_MAP)[HrmGeolocationSpecCode]

export function listHrmGeolocationSpecCodes(): readonly HrmGeolocationSpecCode[] {
  return Object.keys(HRM_GEOLOCATION_SPEC_MAP) as HrmGeolocationSpecCode[]
}
