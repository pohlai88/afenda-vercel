...
import {
  buildRecruitmentApplicationsListSurfaceConfiguration,
  buildRecruitmentPipelineStatConfiguration,
  buildRecruitmentRequisitionsListSurfaceConfiguration,
} from "../data/recruitment-surface-builders.server"
...
export async function RecruitmentPage({ orgSlug }: RecruitmentPageProps) {
  ...
  const requisitionsListConfiguration =
    buildRecruitmentRequisitionsListSurfaceConfiguration(reqs, orgSlug, {
  ...
  const applicationsListConfiguration =
    buildRecruitmentApplicationsListSurfaceConfiguration(apps, orgSlug, {
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <GovernedComponentRenderer
          component={{
            ...
            configuration: requisitionsListConfiguration,
          }}
        />
        <GovernedComponentRenderer
          component={{
            type: "governed:list-surface",
            serverType: "governed:list-surface",
            configuration: applicationsListConfiguration,
          }}
        />
      </div>
