...
/**
 * HR Policies workbench (PR #4 — UI binding for the shipped Phase 2A
 ...
 *    `requireHrmAdmin` independently — this gate is UX, not security.
 ...
 *
 * The active tab is URL-driven (`?tab=…&includeArchived=…`) so deep
...
export async function PoliciesPage({
  ...
  // accept — anything else collapses to "active only".
  const activeTab =
