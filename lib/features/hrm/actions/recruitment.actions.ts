...
import { createEmployeeMutation } from "../data/employee.mutations.server"
...
export async function cancelJobRequisitionAction(
  ...
  auditRecruitment({
    action: "erp.hrm.recruitment.requisition.cancel",
    organizationId,
    userId,
    sessionId,
    resourceType: "hrm_job_requisition",
...
export async function submitInterviewFeedbackAction(
  ...
  auditRecruitment({
    action: "erp.hrm.recruitment.interview.feedback",
    organizationId,
    userId,
    sessionId,
    resourceType: "hrm_interview",
...
export async function createJobOfferAction(
  ...
  auditRecruitment({
    action: "erp.hrm.recruitment.offer.create",
    organizationId,
    userId,
    sessionId,
...
export async function updateJobOfferStatusAction(
  ...
  auditRecruitment({
    action: `erp.hrm.recruitment.offer.${to}`,
    organizationId,
    userId,
    sessionId,
    resourceType: "hrm_job_offer",
...
export async function convertAcceptedOfferToEmployeeAction(
  ...
  auditRecruitment({
    action: "erp.hrm.recruitment.hire.convert",
    organizationId,
    userId,
    sessionId,
    resourceType: "hrm_application",
