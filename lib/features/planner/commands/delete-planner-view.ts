...
import { deletePlannerViewFormSchema } from "../domain/planner.schemas"
import {
  orbitScopedPath,
...
export async function deletePlannerViewAction(
  formData: FormData
): Promise<void> {
  ...
  const parsed = deletePlannerViewFormSchema.safeParse({
