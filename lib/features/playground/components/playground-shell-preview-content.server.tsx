...
import { METADATA_RENDERER_GALLERY_HREF } from "../schemas/playground-paths.shared"
...
export function PlaygroundShellPreviewContent() {
  return (
      ...
      >
        ...
        <ul className="mt-1.5 list-disc space-y-0.5 pl-4">
          <li>
            ...
            <code>AppShellPrimaryLeftRailRaw</code> /{" "}
            <code>SidebarMenuButton</code> — collapse and tooltips via{" "}
            <code>SidebarProvider</code>. Persist key:{" "}
