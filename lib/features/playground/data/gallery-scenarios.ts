...
import {
  GALLERY_NEXUS_PRESSURE_LIST,
  GALLERY_NEXUS_PRIORITY_LANES_LIST,
  GALLERY_NEXUS_RESOLUTIONS_LIST,
} from "./nexus-gallery-fixtures"
...
export const GALLERY_SCENARIOS: readonly GalleryScenario[] = [
  ...
  {
    id: "nexus-pressure",
    title: "Nexus — operational pressure",
    description: "nexus:pressure · governed:list-surface table",
    minWidthPx: 480,
    component: {
      type: "governed:list-surface",
      serverType: "governed:list-surface",
      configuration: GALLERY_NEXUS_PRESSURE_LIST,
    },
  },
  {
    id: "nexus-priority-lanes",
    title: "Nexus — priority lanes",
    description: "nexus:priority-lanes · governed:list-surface table",
    minWidthPx: 480,
    component: {
      type: "governed:list-surface",
      serverType: "governed:list-surface",
      configuration: GALLERY_NEXUS_PRIORITY_LANES_LIST,
    },
  },
  {
    id: "nexus-resolutions",
    title: "Nexus — recent resolutions",
    description: "nexus:resolutions · governed:list-surface table",
    minWidthPx: 480,
    component: {
      type: "governed:list-surface",
      serverType: "governed:list-surface",
      configuration: GALLERY_NEXUS_RESOLUTIONS_LIST,
    },
  },
]
