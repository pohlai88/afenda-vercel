...
import { LYNX_NL_DEMO_TODO_TABLE } from "./nl-sql-demo-guard.shared"

export function buildLynxTodoNlDemoGenerateSqlSystemPrompt(
...
- FROM must be exactly "${LYNX_NL_DEMO_TODO_TABLE}" with double-quoted identifier.
