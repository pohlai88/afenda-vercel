...
type NexusGlobalShortcutsProps = {
  orgSlug: string
}

/**
 * Org-scoped keyboard affordances (navigation chords, quick create, utility focus).
 * Keeps shell chrome keyboard-consistent with {@link NexusUtilityShortcuts}.
 */
export function NexusGlobalShortcuts({ orgSlug }: NexusGlobalShortcutsProps) {
  const router = useRouter()
  const { open, openCommand } = useNexusCommand()
