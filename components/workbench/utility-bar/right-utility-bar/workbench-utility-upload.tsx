...
type WorkbenchUtilityUploadProps = {
  orgId: string
}
 ...
 */
export function WorkbenchUtilityUpload({ orgId }: WorkbenchUtilityUploadProps) {
...
export { buildUploadPath as buildWorkbenchUtilityUploadPath, formatFileSize }
