...
| OneThing                | **`lib/features/onething/`** · public imports **`#features/onething`** only · canonical replacement for the old task surface · routes **`/dashboard/onething`** and **`/account/onething`** · consequence-resolution surface, not task management · **prime directive: optimizes for operational inevitability, not feature discoverability** (see `.cursor/rules/onething-directory.mdc`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
