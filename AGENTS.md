...
| **Other focused rules**       | `.cursor/rules/nextjs-best-practices.mdc`, `i18n-directory.mdc`, `lynx-directory.mdc`, `images.mdc`, `brand-assets.mdc`, `iam-directory.mdc`, `testing-directory.mdc` (`tests/**`), `knip-directory.mdc` (`knip.json`, `package.json`, `scripts/**`), `registry-bases-parity.mdc`, `figma-code-connect-workflow.mdc` |
