...
- **Migration phases.**
  ...
  - **Phase 2:** Nexus-owned slots (`nexus-utility-bar.tsx`, `nexus-dock.tsx`, `nexus-command-layer.tsx`) carry topbar / dock / command; extend **`components/nexus/`** only — legacy **`components/dashboard-shell/`** was removed.
