...
| OneThing                | **`lib/features/onething/`** · public imports **`#features/onething`** only · canonical replacement for the old task surface · routes **`/dashboard/onething`** and **`/account/onething`** · consequence-resolution surface, not task management                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
