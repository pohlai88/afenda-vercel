...
/**
 * Org-scoped operator console error boundary — scoped recovery under `AppSubLayout`.
 *
 * @see https://nextjs.org/docs/app/api-reference/file-conventions/error
 */
export default function OrgOperatorError(props: NextAppErrorPageProps) {
  const { error } = props
