...
export default function OrbitDashboardError(props: NextAppErrorPageProps) {
  const { error } = props
  ...
  const segment = envelope?.orgSlug
    ? `dashboard/${envelope.orgSlug}/orbit`
    : "dashboard/orbit"
  ...
  return (
    <RouteErrorShell>
      ...
      <p className="text-sm text-muted-foreground">
        Something went wrong while rendering the Orbit surface. Try again or
        move to another module while this route recovers.
      </p>
