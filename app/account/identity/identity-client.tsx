...
import type { SafeLinkedAccount } from "#lib/auth"
  ...
  return (
    <div className="mx-auto flex w-full max-w-lg flex-col gap-8 py-6">
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            autoComplete="email"
          />
          <Button type="button" variant="secondary" onClick={() => void requestEmailChange()}>
            Request change
          </Button>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        {props.enabledProviders.filter((p) => !linkedProviderSet.has(p)).length >
        0 ? (
